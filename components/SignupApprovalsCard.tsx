            ...
            <thead>
              <tr style={{ background: '#F1F5F9', color: 'var(--color-ink-2)', textAlign: 'left' }}>
                <th style={{ padding: '0.5rem 0.6rem', width: 40 }}>
                  <input type="checkbox" aria-label="전체 선택" checked={selected.size === approvals.length && approvals.length > 0} onChange={toggleAll} style={{ width: 18, height: 18, cursor: 'pointer' }} />
                </th>
