...
const EVENTS = [
  ...
  { date: '2026-02-11', title: '큐티세미나' },
  { date: '2026-02-18', title: '큐티세미나' },
  ...
  // ===== 2026년 9월 =====
  { date: '2026-09-09', title: '성경대학 개강' }, // (9~11/25) — 개강 단일일
  { date: '2026-09-11', title: '구역지도자모임 및 구역연합예배' },
  { date: '2026-09-20', title: '당회' },
  { date: '2026-09-26', title: '입교세례교육', rule: { freq: 'weekly', interval: 1, count: 4 } }, // 9/26, 10/3, 10/10, 10/17
